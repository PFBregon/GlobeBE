...
import dev.patriciafb.spring.notification.Notification;
import dev.patriciafb.spring.notification.NotificationRepository;
...
public class DataSeeder {
    ...
    public void seedData() {
        ...
        Student patricia = studentRepo.findByUsername("patricia").orElse(null);
        Student ana = studentRepo.findByUsername("ana").orElse(null);

        if (patricia != null) {
            notificationRepo.save(new Notification(
                "¡Bienvenida, Patricia!",
                "Nos alegra tenerte en Globe School. Tu primera clase es el lunes.",
                patricia
            ));
        }
        ...
        if (ana != null) {
            notificationRepo.save(new Notification(
                ...
                "Ana, recuerda que tienes examen de nivel mañana a las 10:00h.",
                ana
            ));
        }
    }
